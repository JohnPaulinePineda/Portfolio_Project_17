...
|                      **[A.1.1.1]** Cross-Validation ROC Curve AUC = 0.78268
|                      **[A.1.1.2]** Test ROC Curve AUC = 0.79803
|             **[A.1.2]** **RF_RFE (Random Forest With Recursive Feature Elimination)**  
|                      **[A.1.2.1]** Cross-Validation ROC Curve AUC = 0.81534
|                      **[A.1.2.2]** Test ROC Curve AUC = 0.84201
...
|                      **[A.2.1.1]** Cross-Validation ROC Curve AUC = 0.80151
|                      **[A.2.1.2]** Test ROC Curve AUC = 0.77199
|             **[A.2.2]** **LDA_RFE (Linear Discriminant Analysis With Recursive Feature Elimination)**
|                      **[A.2.2.1]** Cross-Validation ROC Curve AUC = 0.83569
|                      **[A.2.2.2]** Test ROC Curve AUC = 0.85301
...
|                      **[A.3.1.1]** Cross-Validation ROC Curve AUC = 0.73904
|                      **[A.3.1.2]** Test ROC Curve AUC = 0.68055
|             **[A.3.2]** **NB_RFE (Naive Bayes With Recursive Feature Elimination)**  
|                      **[A.3.2.1]** Cross-Validation ROC Curve AUC = 0.76825
|                      **[A.3.2.2]** Test ROC Curve AUC = 0.75231
...
|                      **[A.4.1.1]** Cross-Validation ROC Curve AUC = 0.70733
|                      **[A.4.1.2]** Test ROC Curve AUC = 0.77199
|             **[A.4.2]** **LR_RFE (Logistic Regression With Recursive Feature Elimination)**
|                      **[A.4.2.1]** Cross-Validation ROC Curve AUC = 0.80296
|                      **[A.4.2.2]** Test ROC Curve AUC = 0.86921
...
|                      **[A.5.1.1]** Cross-Validation ROC Curve AUC = 0.85690
|                      **[A.5.1.2]** Test ROC Curve AUC = 0.82060
|             **[A.5.2]** **SVM_R_RFE (Support Vector Machine - Radial Basis Function Kernel With Recursive Feature Elimination)** 
|                      **[A.5.2.1]** Cross-Validation ROC Curve AUC = 0.84155
|                      **[A.5.2.2]** Test ROC Curve AUC = 0.85995
...
|                      **[A.6.1.1]** Cross-Validation ROC Curve AUC = 0.79886
|                      **[A.6.1.2]** Test ROC Curve AUC = 0.79167
|             **[A.6.2]** **KNN_RFE (K-Nearest Neighbors With Recursive Feature Elimination)**
|                      **[A.6.2.1]** Cross-Validation ROC Curve AUC = 0.79215
|                      **[A.6.2.2]** Test ROC Curve AUC = 0.84143
|
