---
title: 'R : Selecting Informative Predictors Using Recursive Feature Elimination'
...
# **1. Table of Contents**
|
| This document implements recursive feature elimination for selecting informative predictors using various helpful packages in <mark style="background-color: #CCECFF">**R**</mark>.    
|
##  1.1 Sample Data
|
...
|      **[C.2]** ROC Curve AUC = 0.85690
|
| **[D]** The model does not allow for ranking of predictors in terms of variable importance.
|
| **[E]** The independent test model performance of the final model is summarized as follows:
|      **[E.1]** ROC Curve AUC = 0.82060
|
...
|      **[C.2]** ROC Curve AUC = 0.79886
|
| **[D]** The model does not allow for ranking of predictors in terms of variable importance.
|
| **[E]** The independent test model performance of the final model is summarized as follows:
|      **[E.1]** ROC Curve AUC = 0.79167
|
...
|      **[D.2]** ROC Curve AUC = 0.81534
|
| **[E]** The independent test model performance of the final model is summarized as follows:
|      **[E.1]** ROC Curve AUC = 0.84201
|
...
|      **[D.2]** ROC Curve AUC = 0.83569
|
| **[E]** The independent test model performance of the final model is summarized as follows:
|      **[E.1]** ROC Curve AUC = 0.85301
|
...
|      **[D.2]** ROC Curve AUC = 0.76825
|
| **[E]** The independent test model performance of the final model is summarized as follows:
|      **[E.1]** ROC Curve AUC = 0.75231
|
...
|      **[D.2]** ROC Curve AUC = 0.80296
|
| **[E]** The independent test model performance of the final model is summarized as follows:
|      **[E.1]** ROC Curve AUC = 0.86921
|
...
|      **[D.2]** ROC Curve AUC = 0.84155
|
| **[E]** The independent test model performance of the final model is summarized as follows:
|      **[E.1]** ROC Curve AUC = 0.85995
|
...
|      **[D.2]** ROC Curve AUC = 0.79215
|
| **[E]** The independent test model performance of the final model is summarized as follows:
|      **[E.1]** ROC Curve AUC = 0.84143
|
...
|             **[A.1.1]** RF_FULL: Cross-Validation ROC Curve AUC = 0.78268, Test ROC Curve AUC = 0.79803 
|             **[A.1.2]** RF_RFE: Cross-Validation ROC Curve AUC = 0.81534, Test ROC Curve AUC = 0.84201  
|      **[A.2]** LDA: Linear Discriminant Analysis (<mark style="background-color: #CCECFF">**MASS**</mark> package)
|             **[A.2.1]** LDA_FULL: Cross-Validation ROC Curve AUC = 0.80151, Test ROC Curve AUC = 0.77199 
|             **[A.2.2]** LDA_RFE: Cross-Validation ROC Curve AUC = 0.83569, Test ROC Curve AUC = 0.85301 
...
|             **[A.3.2]** NB_RFE: Cross-Validation ROC Curve AUC = 0.76825, Test ROC Curve AUC = 0.75231 
|      **[A.4]** LR: Logistic Regression (<mark style="background-color: #CCECFF">**stats**</mark> package)
|             **[A.4.1]** LR_FULL: Cross-Validation ROC Curve AUC = 0.70733, Test ROC Curve AUC = 0.77199 
|             **[A.4.2]** LR_RFE: Cross-Validation ROC Curve AUC = 0.80296, Test ROC Curve AUC = 0.86921 
|      **[A.5]** SVM_R: Support Vector Machine - Radial Basis Function Kernel (<mark style="background-color: #CCECFF">**kernlab**</mark> package)
|             **[A.5.1]** SVM_R_FULL: Cross-Validation ROC Curve AUC = 0.85690, Test ROC Curve AUC = 0.82060 
|             **[A.5.2]** SVM_R_RFE: Cross-Validation ROC Curve AUC = 0.84155, Test ROC Curve AUC = 0.85995 
|      **[A.6]** KNN: K-Nearest Neighbors (<mark style="background-color: #CCECFF">**caret**</mark> package)
|             **[A.6.1]** KNN_FULL: Cross-Validation ROC Curve AUC = 0.79886, Test ROC Curve AUC = 0.79167 
|             **[A.6.2]** KNN_RFE: Cross-Validation ROC Curve AUC = 0.79215, Test ROC Curve AUC = 0.84143 
|
| **[B]** The models applied with recursive feature elimination which demonstrated the best and most consistent ROC Curve AUC metrics are as follows:
